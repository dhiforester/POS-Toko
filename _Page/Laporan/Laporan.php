...
<script>
    $(document).ready(function(){
        //LaporanJualBeli
        $('#LaporanJualBeli').focus(function(){
            $('#LaporanJualBeli').removeClass('btn-outline-primary');
            $('#LaporanJualBeli').addClass('btn-primary');
        });
        $('#LaporanJualBeli').focusout(function(){
            $('#LaporanJualBeli').removeClass('btn-primary');
            $('#LaporanJualBeli').addClass('btn-outline-primary');
        });
        //TombolLaporanUtangPiutang
        $('#TombolLaporanUtangPiutang').focus(function(){
            $('#TombolLaporanUtangPiutang').removeClass('btn-outline-primary');
            $('#TombolLaporanUtangPiutang').addClass('btn-primary');
        });
        $('#TombolLaporanUtangPiutang').focusout(function(){
            $('#TombolLaporanUtangPiutang').removeClass('btn-primary');
            $('#TombolLaporanUtangPiutang').addClass('btn-outline-primary');
        });
        //LaporanJualBeli
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col col-md-12">
                        ...
                        <button type="button" title="Laporan Utang Piutang" class="btn btn-sm btn-outline-primary" id="TombolLaporanUtangPiutang">
                            Utang/Piutang
                        </button>
                        <!---
                        <button type="button" title="Laporan Laba Rugi" class="btn btn-sm btn-outline-info" id="TombolLaporanLabaRugi">
                            Laba/Rugi
                        </button>
