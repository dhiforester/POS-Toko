<script>
    ...
    $('#ProsesTampilkanLaporanJualBeli').submit(function(){ 
        var Loading='<div class="row text-center"><div class="form-group col col-md-12"><img src="images/loading.gif"></div></div>';
        var ProsesTampilkanLaporanJualBeli=$('#ProsesTampilkanLaporanJualBeli').serialize();
        $('#KontenLaporan').html(Loading);
        $.ajax({
            type 	: 'POST',
            url 	: '_Page/Laporan/TabelLaporanJualBeli.php',
            data 	:  ProsesTampilkanLaporanJualBeli,
...
<form action="javascript:void(0);" id="ProsesTampilkanLaporanJualBeli">
