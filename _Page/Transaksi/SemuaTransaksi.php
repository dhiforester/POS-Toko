    <div class="row">
        <div class="form-group col-sm-6">
            <a href="_page/Transaksi/CetakSemuaTransaksi.php?Awal=<?php echo $Awal; ?>&Akhir=<?php echo $Akhir; ?>" class="btn btn-primary" target="_blank">
                HTML
            </a>
            <a href="_page/Transaksi/CetakSemuaTransaksiExcel.php?Awal=<?php echo $Awal; ?>&Akhir=<?php echo $Akhir; ?>" class="btn btn-warning" target="_blank">
                Excel
            </a>
        </div>
    </div>
